...
VOICE = "en-IN-PrabhatNeural" # 100% Human Confident Indian Male
...
FACTS_DB = [
    ...
    ("Samudra ke andar nadi", "Samudra ke andar paintis kilometer lambi ek nadi behti hai, jiska paani das guna zyada namkeen hai"),
    ("Ped baat karte hain", "Ped ek dusre se baat karte hain, zameen ke niche unki jadein internet ki tarah judi hui hain"),
    ("Shahad kharab nahi hota", "Teen hazar saal purana shahad bhi khane layak hota hai, ye kabhi kharab nahi hota"),
    ("Octopus ke teen dil", "Octopus ke teen dil hote hain aur uska khoon neele rang ka hota hai"),
    ("Dharti ka garam dil", "Dharti ke andar lohe ki ek gend hai jo Suraj jitni garam hai"),
    ("Space me aansu", "Space me rone par aansu neeche nahi girte, aankh me hi chipke rehte hain"),
...
HOOKS = [
    ...
    "Ninety nine percent log ye nahi jante",
...
async def make_human_voice(full_text):
    # Hindi numbers pehle se likhe hain, isliye ninety-six nahi bolega
    #... se natural pause aayega, break tag nahi
